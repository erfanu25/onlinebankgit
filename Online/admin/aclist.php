                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" >Active Acounts</div>
  ...
  while($row1=$qry->fetch_assoc() ){
    ...
    <tr class="item">
      ...
      <form method="post">
        ...
        <td class=" ">
          <button type="submit" name="block" class="btn btn-danger m-t-15 waves-effect" onclick="window.location.reload()">Block</button>
