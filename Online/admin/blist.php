                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" >Block Acounts</div>
  ...
  while($row1=$qry->fetch_assoc() ){
    ...
    <tr class="item">
      ...
      <form method="post">
        ...
        <td class=" ">
          <button type="submit" name="unblock" class="btn btn-danger m-t-15 waves-effect" onclick="window.location.reload()">Unblock</button>
...
if ($done) {
  echo "<script> document.location.href='blist.php';</script>";
}else {
